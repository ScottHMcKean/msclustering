...
gg_stage_plot <- function(ms_df, comp_df, surv_df, well = 1,
  ...
  if (outlier == 0){
    ggsave(file = paste(output_path,label,"_W",well,"_","S",stage,"_HF.png",sep=""),
           g, width = 20, height = 20, units = 'cm', dpi = 320)
  } else {
    ggsave(file = paste(output_path,label,"_W",well,"_","S",stage,"_OUT.png",sep=""),
           g, width = 20, height = 20, units = 'cm', dpi = 320)
  }
}
...
#' @param label optional label for filenames
#' @export
gg_well_plot <- function(ms_df, comp_df, surv_df, well = 1,
                          outlier = 0,
                          title = TRUE, legend_bool = FALSE,
                          label = "", output_path = "../output/",
                          elev_lim = c(-3000,-2000),
  ...
  if (outlier == 0){
    ggsave(file = paste(output_path,label,"_W",well,"_","_HF.png",sep=""),
           g, width = 20, height = 20, units = 'cm', dpi = 320)
  } else {
    ggsave(file = paste(output_path,label,"_W",well,"_","_OUT.png",sep=""),
           g, width = 20, height = 20, units = 'cm', dpi = 320)
  }
}